...
public class mood_ter_step5_6_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mood_ter_step5_6);
        ...
        //語音
        MediaPlayer mp = MediaPlayer.create(this, R.raw. mood_ter_step5_6);
        mp.start();
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(mood_ter_step5_6_activity.this,main_activity.class);
