...
public class mood_ter_step4_1_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mood_ter_step4_1);
        ...
        //語音
        MediaPlayer mp = MediaPlayer.create(this, R.raw. mood_ter_step4_1);
        mp.start();
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(mood_ter_step4_1_activity.this,main_activity.class);
        ...
        nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳至下一頁面
                Intent intent =new Intent(mood_ter_step4_1_activity.this, mood_ter_step4_2_activity.class);
                startActivity(intent);
                mp.pause();
                mp.release();
            }
