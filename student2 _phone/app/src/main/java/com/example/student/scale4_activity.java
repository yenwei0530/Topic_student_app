...
public class scale4_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //將答案存入全域變數
                gv.setscale4(t1.getText().toString().substring(0,1));
        ...
        uppage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(scale4_activity.this, scale3_activity.class);
                startActivity(intent);
                finish();
            }
        });
