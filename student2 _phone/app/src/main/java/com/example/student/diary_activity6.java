...
public class diary_activity6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.diary6);
        ...
        nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //將內容存入全域變數
                gv.setdiary6(edt1.getText().toString());
                ...
                if(edt1.getText().toString().matches("")){
                    ...
                    //用setView把layout放進去
                    AlertDialog.Builder builder = new AlertDialog.Builder(diary_activity6.this);
        ...
        uppage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //關閉目前頁面
                Intent intent = new Intent(diary_activity6.this, diary_activity5.class);
                startActivity(intent);
                mp.pause();
                mp.release();
                finish();
