    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animTxtScale.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                txt4.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20 + val);
            }
        });
        animTxtScale.start();
        ...
        //語音
        MediaPlayer mp = MediaPlayer.create(this, R.raw.diary5);
        mp.start();
        ...
        uppage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //關閉目前頁面
                Intent intent =new Intent(diary_activity5.this, diary_activity4.class);
                startActivity(intent);
                mp.pause();
                mp.release();
                finish();
