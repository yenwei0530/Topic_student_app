...
public class scale5_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.scale5);
        ...
        nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //將答案存入全域變數
                gv.setscale5(t1.getText().toString().substring(0,1));
        ...
        uppage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(scale5_activity.this, scale4_activity.class);
                startActivity(intent);
                finish();
            }
        });
