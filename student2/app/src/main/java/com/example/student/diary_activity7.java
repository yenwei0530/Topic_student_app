...
public class diary_activity7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.diary7);
        ...
        //語音
        MediaPlayer mp = MediaPlayer.create(this, R.raw.diary7);
        mp.start();
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳至主頁面
                Intent intent =new Intent(diary_activity7.this,main_activity.class);
