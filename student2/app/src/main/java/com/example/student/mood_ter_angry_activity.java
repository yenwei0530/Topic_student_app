...
public class mood_ter_angry_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mood_ter_angry);
        ...
        nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳至下一頁面
                Intent intent =new Intent(mood_ter_angry_activity.this,mood_ter_angry_activity2.class);
